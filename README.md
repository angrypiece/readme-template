...
Add a screenshot of your solution. The easiest way to do this is to open Developer console and then right click html element and select where it says "capture node as screenshot".
